...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 127
    .local v0, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;>;"
    ...
    .line 137
    new-instance v5, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;

    invoke-direct {v5}, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;-><init>()V

    .line 138
    .local v5, "_hidl_vec_element":Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;
    mul-int/lit8 v6, v4, 0x38

    int-to-long v6, v6

    invoke-virtual {v5, p0, v3, v6, v7}, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 139
    invoke-virtual {v0, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 136
    .end local v5    # "_hidl_vec_element":Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    .line 174
    .local p1, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;>;"
    ...
    check-cast v4, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;

    mul-int/lit8 v5, v3, 0x38

    int-to-long v5, v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;

    .line 81
    .local v2, "other":Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;
    iget-byte v3, p0, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->hidl_d:B

    iget-byte v4, v2, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->hidl_d:B
    ...
    .line 84
    :cond_3
    iget-object v3, p0, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->hidl_o:Ljava/lang/Object;

    iget-object v4, v2, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->hidl_o:Ljava/lang/Object;
...
.method public noinit()Landroid/hidl/safe_union/V1_0/Monostate;
    ...
    .line 37
    invoke-static {v3}, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor$hidl_discriminator;->getName(B)Ljava/lang/String;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    check-cast v3, Landroid/hardware/radio/V1_6/TrafficDescriptor;

    add-long/2addr v1, p3

    invoke-virtual {v0, p1, p2, v1, v2}, Landroid/hardware/radio/V1_6/TrafficDescriptor;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    .line 104
    invoke-virtual {p0}, Landroid/hardware/radio/V1_6/OptionalTrafficDescriptor;->noinit()Landroid/hidl/safe_union/V1_0/Monostate;
...
.method public value()Landroid/hardware/radio/V1_6/TrafficDescriptor;
    .locals 4
...
.method public value(Landroid/hardware/radio/V1_6/TrafficDescriptor;)V
    .locals 1
    .param p1, "value"    # Landroid/hardware/radio/V1_6/TrafficDescriptor;
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/hardware/radio/V1_6/TrafficDescriptor;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
